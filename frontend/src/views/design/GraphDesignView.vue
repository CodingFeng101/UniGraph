  ...
  <div class="flex flex-1 min-h-0">
    <div class="flex-1 relative min-w-0 overflow-hidden" style="background:var(--claude-secondary);">
      ...
      <div id="canvas-tooltip" class="hidden absolute z-50 rounded-xl overflow-hidden" @mouseleave="hideTooltip()" style="background:var(--claude-card);border:1px solid var(--claude-border);box-shadow:var(--claude-shadow-lg);width:260px;">
        ...
        <div id="tooltip-body" class="px-4 py-3"></div>
        <div class="px-4 py-2 flex items-center gap-2" style="border-top:1px solid var(--claude-border);">
          <button @click="hideTooltip();editSelectedElement()" class="text-[11px] font-medium transition-colors hover:opacity-70" style="color:var(--claude-primary);">编辑</button>
          <span style="color:var(--claude-border);">|</span>
          <button @click="hideTooltip();deleteSelectedElement()" class="text-[11px] font-medium transition-colors hover:opacity-70" style="color:var(--claude-destructive);">删除</button>
        </div>
      </div>

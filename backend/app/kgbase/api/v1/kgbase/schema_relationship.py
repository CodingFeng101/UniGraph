...
async def get_all_schema_relationships(schema_graph_uuid: Annotated[str, Path(...)]) -> ResponseModel:
...
async def get_schema_relationship(uuid: Annotated[str, Path(...)]) -> ResponseModel:
...
async def create_schema_relationship(obj: AddSchemaRelationshipParam) -> ResponseModel:
...
async def update_schema_relationship(
    uuid: Annotated[str, Path(...)], obj: UpdateSchemaRelationshipParam
) -> ResponseModel:
...
async def delete_schema_relationship(uuid: Annotated[str, Path(...)]) -> ResponseModel:
...
async def update_schema_relationship_status(pk: Annotated[int, Path(...)]) -> ResponseModel:
